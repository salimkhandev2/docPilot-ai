  ...
  try {
    ...
    if (isFormData) {
      ...
      if (imageFile && imageFile instanceof File) {
        console.log(`🖼️  Processing uploaded image file: ${imageFile.name}\n`);
...
STRICT RULES:
1. DO NOT use \`\`\`html or \`\`\` code blocks
2. DO NOT include <!DOCTYPE>, <html>, <head>, or <body> tags
3. Preserve all id and class attributes unless instructed otherwise
4. use Tailwind CSS classes for styling
5. DO NOT add any animations, transitions, or hover effects (no scale, transform, transition, hover: classes, etc.)
...
Generate the modified HTML now:`;
    ...
    if (imageData) {
      ...
      console.log(`🖼️  Processing prompt with image (base64)...\n`);
      ...
      // ---------------------
      console.log(`🖼️  Processing prompt with image from URL: ${imageUrl}\n`);
      try {
        // Check if it's a URL
